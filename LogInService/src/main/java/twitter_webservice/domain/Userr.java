...
public class Userr implements Serializable {
    ...
    private List<twitter_webservice.domain.Userr> followers;

    @JsonIgnore
    @ManyToMany(cascade = {CascadeType.PERSIST, CascadeType.MERGE}, fetch=FetchType.LAZY)
    @JoinTable(name="FOLLOWING")
    private List<twitter_webservice.domain.Userr> following;
    ...
    public Userr(String password, String email, String name, String userName, String biografy, String locationX, String locationY, String website, String pictureUrl) {
        ...
        this.website = website;
        this.followers = new ArrayList<twitter_webservice.domain.Userr>();
        this.following = new ArrayList<twitter_webservice.domain.Userr>();
    ...
    public List<twitter_webservice.domain.Userr> getFollowing() {
        return following;
    }

    public void setFollowing(List<twitter_webservice.domain.Userr> following) {
        this.following = following;
    }

    public List<twitter_webservice.domain.Userr> getFollowers() {
        return followers;
    }

    public void setFollowers(List<twitter_webservice.domain.Userr> followers) {
    ...
    public void addFollower(twitter_webservice.domain.Userr user){
        this.followers.add(user);
    }

    public void addFollowing(twitter_webservice.domain.Userr user){
